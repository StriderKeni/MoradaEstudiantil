...
public class ProfileActivity extends Activity implements OnClickListener,
    ...
    private TextView txtName, txtEmail, txtRegisterUser;
    private LinearLayout llProfileLayout;
    String urlImageProfile;
    private EditText editEmailLogin, editContrasenaLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editEmailLogin = (EditText) findViewById(R.id.edit_email_login);
        editContrasenaLogin = (EditText) findViewById(R.id.edit_contrasena_login);
    ...
    private void signOutFromGplus() {
        if (mGoogleApiClient.isConnected()) {
            ...
            loginSharedPreferences = getSharedPreferences("loginPreferences", 0);
